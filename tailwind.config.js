  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        'blur-light-in': {
          '0%': { filter: 'blur(0px)', boxShadow: '0 0 0px 0px rgba(14, 165, 233, 0)' },
          '100%': { filter: 'blur(4px)', boxShadow: '0 0 20px 5px rgba(14, 165, 233, 0.7)' },
        },
        'blur-light-out': {
          '0%': { filter: 'blur(4px)', boxShadow: '0 0 20px 5px rgba(14, 165, 233, 0.7)' },
          '100%': { filter: 'blur(0px)', boxShadow: '0 0 0px 0px rgba(14, 165, 233, 0)' },
        }
      },
      animation: {
